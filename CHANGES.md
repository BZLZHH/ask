...
- The Judge prompt is simpler and more explicit, and decision parsing now accepts bye/quit aliases and explanatory phrases that still identify the final CONTINUE or EXIT decision.
